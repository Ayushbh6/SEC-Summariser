...
export default function ForgotPasswordPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#e8e8e8] to-[#d4d4d4] flex items-center justify-center px-4 lg:px-6 py-12">
        ...
        <div className="text-center mb-6 lg:mb-8">
          <Link href="/">
            <div className="neumorphic-container inline-block px-4 lg:px-6 py-2 lg:py-3 mb-4 lg:mb-6 cursor-pointer">
              <h1 className="text-xl lg:text-2xl font-bold text-gray-700">SEC Summariser</h1>
            </div>
          </Link>
          <h2 className="text-2xl lg:text-3xl font-bold text-gray-800 mb-2">Reset Password</h2>
          <p className="text-sm lg:text-base text-gray-600">Enter your email to receive a password reset link</p>
        </div>
              ...
              <div>
                ...
                <div className="neumorphic-container p-3 lg:p-4">
                  <input
                    ...
                    className="w-full bg-transparent outline-none text-sm lg:text-base text-gray-800 placeholder-gray-500"
