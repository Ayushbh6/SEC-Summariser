      ...
      <header className="w-full px-6 py-4">
        <nav className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            <ThemeToggle />
            <Link href="/signin">
              <button className="neumorphic-button px-6 py-3 text-[var(--foreground)] font-medium transition-all duration-200 hover:neumorphic-pressed">
                Sign In
              </button>
            </Link>
            <Link href="/signup">
      ...
      <main className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center space-y-12">
          ...
          <div className="neumorphic-container-large p-12 max-w-4xl mx-auto">
            ...
            <p className="text-xl text-[var(--foreground-secondary)] max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-16">
            <div className="neumorphic-card p-8 text-center space-y-4">
              ...
              <h3 className="text-xl font-semibold text-[var(--foreground)]">Smart Document Retrieval</h3>
            ...
            <div className="neumorphic-card p-8 text-center space-y-4">
              ...
              <h3 className="text-xl font-semibold text-[var(--foreground)]">Structured Analysis</h3>
              <p className="text-[var(--foreground-secondary)]">
            ...
            <div className="neumorphic-card p-8 text-center space-y-4">
              ...
              <h3 className="text-xl font-semibold text-[var(--foreground)]">AI-Powered Chat</h3>
              <p className="text-[var(--foreground-secondary)]">
